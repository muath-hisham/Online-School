  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="a_students.php">Students</a>
        </li>
        <li class="nav-item">
            ...
            <td>
              <?php if ($data['St_img'] != NULL) {
                ...
                if ($data['St_gender'] == 'male') {
                  echo " <img src='../../images/img_avatar.png' alt='Person'>";
                } else {
                  echo " <img src='../../images/img_avatar2.png' alt='Person'>";
                }
              }
              ?>
            </td>
